...
<?php
if ($_SERVER['REQUEST_URI'] == '/user/profile.php?language=pt-br.php' ||  $_SERVER['REQUEST_URI'] == '/user/profile_cadastro.php?language=pt-br.php' || $_SERVER['REQUEST_URI'] == '/user/profile.php?language=en-us.php' ||  $_SERVER['REQUEST_URI'] == '/user/profile_cadastro.php?language=en-us.php') {
	include "menu.php";
}
// session_start();
